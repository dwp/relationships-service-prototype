...
module.exports = router => {
  ...
  router.post('/appointee/iteration-9/', function (req, res) {
    // Prototype information
    req.session.data['iteration-number'] = 9;
    ...
    req.session.data['appointee-residential-address'] = req.session.data['appointee-residential-line-1'] + ', ' +  req.session.data['appointee-residential-line-2'] + ', ' +  req.session.data['appointee-residential-line-3'] + ', ' +  req.session.data['appointee-residential-postcode'] + ', ' +  req.session.data['appointee-residential-country'];
      // End of information
    res.redirect('/appointee/iteration-9/searchlight/');
  });



  router.post('/appointee/iteration-9/searchlight/', function (req, res) {
    if (req.session.data['journey-choice'] == 'authorise') {
      res.redirect('/appointee/iteration-9/searchlight/customer/proposed');
    } else { 
      res.redirect('/appointee/iteration-9/searchlight/customer/');
    }
  });
  
  router.post('/appointee/iteration-9/searchlight/customer/', function (req, res) {
    res.redirect('/appointee/iteration-9/propose/details');
  });
  
  router.post('/appointee/iteration-9/propose/', function (req, res) {
    if (req.session.data['appointee-nino-choice'] == 'yes') {
      res.redirect('/appointee/iteration-9/propose/nino');
    } else {
      res.redirect('/appointee/iteration-9/propose/details');
    }
  });
  
  router.post('/appointee/iteration-9/propose/nino', function (req, res) {
    res.redirect('/appointee/iteration-9/propose/summary');
  });
  
  router.post('/appointee/iteration-9/propose/details', function (req, res) {
    if (req.session.data['journey-choice'] == 'propose') {
      res.redirect('/appointee/iteration-9/propose/summary');
    } else if (req.session.data['journey-choice'] == 'scenario-2') {
      res.redirect('/appointee/iteration-9/service/service-down');
    } else {
      res.redirect('/appointee/iteration-9/service/no-match-found');
    }
  });
  ...
  //router.post('/appointee/iteration-9/propose/appointee-correct', function (req, res) {
  //  if (req.session.data.appointeeCorrect == 'appointee-correct-yes') {
  //    req.session.data.relationshipStatus = 'asserted';
  //    res.redirect('/appointee/iteration-9/propose/confirmation');
  //  } else {
  //    req.session.data.authorisedUser = null;
  //    res.redirect('/appointee/iteration-9/propose/');
  //  }
  //});
  
  router.post('/appointee/iteration-9/propose/summary', function (req, res) {
    req.session.data.relationshipStatus = 'asserted';
    res.redirect('/appointee/iteration-9/searchlight/customer/proposed');
  });
  
  router.post('/appointee/iteration-9/searchlight/customer/proposed', function (req, res) {
    req.session.data['journey-choice'] = 'authorise';
    res.redirect('/appointee/iteration-9/authorise/');
  });

  router.post('/appointee/iteration-9/searchlight/appointee/proposed', function (req, res) {
    req.session.data['journey-choice'] = 'authorise';
    res.redirect('/appointee/iteration-9/authorise/');
  });
  ...
  router.post('/appointee/iteration-9/searchlight/customer/not-authorised', function (req, res) {
    res.redirect('/appointee/iteration-9/propose/details');
  });

  router.post('/appointee/iteration-9/authorise/', function (req, res) {
    res.redirect('/appointee/iteration-9/authorise/decision-date');
  });
  
  router.post('/appointee/iteration-9/authorise/decision-date', function (req, res) {
    if (req.session.data['decision-date'] == 'today') {
      if (req.session.data['verified-appointeeship'] == 'authorised') {
        ...
        res.redirect('/appointee/iteration-9/authorise/authorised/review-date');
      } else {
        req.session.data.relationshipStatus = 'not-authorised';
        res.redirect('/appointee/iteration-9/authorise/not-authorised/summary');
      }
    } else {
      res.redirect('/appointee/iteration-9/authorise/decision-date-manual');
    }
  });
  
  router.post('/appointee/iteration-9/authorise/decision-date-manual', function (req, res) {
    if (req.session.data['verified-appointeeship'] == 'authorised') {
      req.session.data.relationshipStatus = 'authorised';
      res.redirect('/appointee/iteration-9/authorise/authorised/review-date');
    } else {
  ...
  router.post('/appointee/iteration-9/authorise/authorised/', function (req, res) {
    if (req.session.data['verified-date'] == 'today') {
      res.redirect('/appointee/iteration-9/authorise/authorised/review-date');
    } else {
      res.redirect('/appointee/iteration-9/authorise/authorised/date');
    }
  });
  
  router.post('/appointee/iteration-9/authorise/authorised/review-date', function (req, res) {
    if (req.session.data['review-date'] == 'custom') {
      res.redirect('/appointee/iteration-9/authorise/authorised/custom-review-date');
    } else {
      ...
      res.redirect('/appointee/iteration-9/authorise/authorised/summary');
    }
  });
  
  router.post('/appointee/iteration-9/authorise/authorised/date', function (req, res) {
    res.redirect('/appointee/iteration-9/authorise/authorised/review-date');
  });
  
  router.post('/appointee/iteration-9/authorise/authorised/custom-review-date', function (req, res) {
    res.redirect('/appointee/iteration-9/authorise/authorised/summary');
  });
  
  router.post('/appointee/iteration-9/authorise/authorised/summary', function (req, res) {
    res.redirect('/appointee/iteration-9/searchlight/customer/authorised');
  });
  
  // Declined
  
  router.post('/appointee/iteration-9/authorise/not-authorised/', function (req, res) {
    if (req.session.data['declined-date'] == 'today') {
      res.redirect('/appointee/iteration-9/authorise/not-authorised/summary');
    } else {
      res.redirect('/appointee/iteration-9/authorise/not-authorised/date');
    }
  });
  
  router.post('/appointee/iteration-9/authorise/not-authorised/date', function (req, res) {
    res.redirect('/appointee/iteration-9/authorise/not-authorised/summary');
  });
  
  router.post('/appointee/iteration-9/authorise/not-authorised/summary', function (req, res) {
    res.redirect('/appointee/iteration-9/searchlight/customer/not-authorised');
  });
  
  // Change
  
  router.post('/appointee/iteration-9/propose/change/details', function (req, res) {
    // changed values
    req.session.data['appointee-dob'] = '25 March 1993';
    res.redirect('/appointee/iteration-9/propose/change/summary');
  });
  
  router.post('/appointee/iteration-9/propose/change/summary', function (req, res) {
    req.session.data.relationshipStatus = 'asserted';
    res.redirect('/appointee/iteration-9/searchlight/customer/proposed');
  });
