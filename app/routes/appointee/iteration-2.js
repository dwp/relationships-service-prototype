...
router.post('/appointee/iteration-2/', function (req, res) {
  // Relationship information
  req.session.data['relationship-decision-day'] = 29;
  req.session.data['relationship-decision-month'] = 'June';
  req.session.data['relationship-decision-year'] = 2022;
  req.session.data['relationship-declined-reason'] = 'Reason goes here';
  ...
  if (req.session.data['journey-choice'] == 'propose') {
    res.redirect('/appointee/iteration-2/searchlight/');
  } else {
    res.redirect('/appointee/iteration-2/task/');
  }
});

router.post('/appointee/iteration-2/searchlight/', function (req, res) {
  res.redirect('/appointee/iteration-2/searchlight/result');
});

router.post('/appointee/iteration-2/searchlight/result', function (req, res) {
  res.redirect('/appointee/iteration-2/propose/');
});

router.post('/appointee/iteration-2/propose/', function (req, res) {
  if (req.session.data['appointee-nino-choice'] == 'yes') {
    res.redirect('/appointee/iteration-2/propose/nino');
  } else {
    res.redirect('/appointee/iteration-2/propose/details');
  }
});

router.post('/appointee/iteration-2/propose/nino', function (req, res) {
  res.redirect('/appointee/iteration-2/propose/summary');
});

router.post('/appointee/iteration-2/propose/details', function (req, res) {
  res.redirect('/appointee/iteration-2/propose/summary');
});

//router.post('/appointee/iteration-2/propose/appointee-correct', function (req, res) {
//  if (req.session.data.appointeeCorrect == 'appointee-correct-yes') {
//    req.session.data.relationshipStatus = 'asserted';
//    res.redirect('/appointee/iteration-2/propose/confirmation');
//  } else {
...
router.post('/appointee/iteration-2/propose/summary', function (req, res) {
  req.session.data.relationshipStatus = 'asserted';
  res.redirect('/appointee/iteration-2/searchlight/relationships');
});

// ****** Verify Relationship ******* //

router.post('/appointee/iteration-2/task/', function (req, res) {
  res.redirect('/appointee/iteration-2/verify/');
});

router.post('/appointee/iteration-2/verify/', function (req, res) {
  if (req.session.data['verified-appointeeship'] == 'verified') {
    req.session.data.relationshipStatus = 'verified';
    res.redirect('/appointee/iteration-2/verify/verified/');
  } else {
    req.session.data.relationshipStatus = 'declined';
    res.redirect('/appointee/iteration-2/verify/declined/');
  }
});

// Verified

router.post('/appointee/iteration-2/verify/verified/', function (req, res) {
  if (req.session.data['verified-date'] == 'today') {
    res.redirect('/appointee/iteration-2/verify/verified/review-date');
  } else {
    res.redirect('/appointee/iteration-2/verify/verified/date');
  }
});

router.post('/appointee/iteration-2/verify/verified/review-date', function (req, res) {
  if (req.session.data['review-date'] == 'custom') {
    res.redirect('/appointee/iteration-2/verify/verified/custom-review-date');
  } else {
    ...
    res.redirect('/appointee/iteration-2/verify/verified/summary');
  }
});

router.post('/appointee/iteration-2/verify/verified/date', function (req, res) {
  res.redirect('/appointee/iteration-2/verify/verified/review-date');
});

router.post('/appointee/iteration-2/verify/verified/custom-review-date', function (req, res) {
  res.redirect('/appointee/iteration-2/verify/verified/summary');
});

router.post('/appointee/iteration-2/verify/verified/summary', function (req, res) {
  res.redirect('/appointee/iteration-2/searchlight/verified');
});

// Declined

router.post('/appointee/iteration-2/verify/declined/', function (req, res) {
  if (req.session.data['declined-date'] == 'today') {
    res.redirect('/appointee/iteration-2/verify/declined/reason');
  } else {
    res.redirect('/appointee/iteration-2/verify/declined/date');
  }
});

router.post('/appointee/iteration-2/verify/declined/reason', function (req, res) {
  res.redirect('/appointee/iteration-2/verify/declined/summary');
});

router.post('/appointee/iteration-2/verify/declined/date', function (req, res) {
  res.redirect('/appointee/iteration-2/verify/declined/reason');
});

router.post('/appointee/iteration-2/verify/declined/summary', function (req, res) {
  res.redirect('/appointee/iteration-2/searchlight/relationships');
});
